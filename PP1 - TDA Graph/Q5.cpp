...
DigraphAL::DigraphAL(unsigned int qtd_vertices) : num_vertices(qtd_vertices)
{
...
void input_graph(DigraphAL &g, unsigned int num_edges, char const *argv[], int argc)
{
    unsigned int num_vertices;
